...
export default function MoodCheckScreen({navigation}) {
  ...
  // moodObjectArray = moodArray.eachAndIndex((mood, index) => {return {id: index, name: mood, selected: false}})
  ...
  const buttons = moodObjectArray.map(function(moods) {
    var component = Components[moodData['name']];
    return React.createElement(component, {
        name: moodData,
        key: moodData['id'],
        selected: moodData['selected']
    });
  });
